...
import {
  ...
  IBoardsServiceTest,
} from './interfaces/boards-service.interfacet';
...
export class BoardsService {
  ...
  create({ createBoardInput }: IBoardsServiceCreate): string {
    ...
    console.log(createBoardInput.Phone);
  ...
  test({ testInput, qqq }: IBoardsServiceTest): any {
    console.log(testInput.writer);
    console.log(testInput.content);
    console.log(testInput.title);

    console.log(qqq);
  }

  BoardTest({ writer, title, contents }): string {
    console.log(writer);
    console.log(title);
    console.log(contents);
    return '등록하였습니다.';
